...
CUDA_VISIBLE_DEVICES=0 nohup python train_focus.py --train_batch_size=2 --n_epochs 2 --lm_coef 10 --flag E2_L10 --model_name BART --incontext > train_log_focus/e2_L20_bart.log &
