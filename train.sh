...
CUDA_VISIBLE_DEVICES=0 nohup python train_focus.py --n_epochs 2 --lm_coef 10 --flag E2_L10 --model_name BART --incontext --debug=True --train_batch_size=2 > train_log_focus/e2_L20_bart.log &
