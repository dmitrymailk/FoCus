...
CUDA_VISIBLE_DEVICES=0 python train_focus.py --train_batch_size=2 --n_epochs 2 --lm_coef 10 --flag E2_L10 --model_name BART --incontext --debug && rm -rf ./models/train_focus_BART_E2_L10
